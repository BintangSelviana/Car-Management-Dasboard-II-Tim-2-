...
Untuk mulai membuat sebuah implementasi dari HTTP Server, mulainya menginspeksi file [`app/server/index.js`](./app/index.js), dan lihatlah salah satu contoh `controller` yang ada di [`app/controllers/mainController.js`](./app/controllers/mainController.js)
